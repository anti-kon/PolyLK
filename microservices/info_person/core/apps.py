...
class CoreConfig(AppConfig):
    ...
    def ready(self):
        eureka_client.init(eureka_server=f"http://"
                                         ...
                                         f"/eureka/",
                           app_name=os.environ.get('POLYLK_INFO_PERSON_NAME'),
                           instance_port=int(os.environ.get('POLYLK_INFO_PERSON_PORT')),
                           instance_host=os.environ.get('POLYLK_INFO_PERSON_HOSTNAME'),
