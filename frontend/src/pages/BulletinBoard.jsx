...
const BulletinBoard = () => {
    ...
    const advertisements = [{id: 0, login: "User1", text: "Написание текстов для главных страниц сайта – дело непростое. Проблема в том, что существует сразу несколько подходов к подготовке таких материалов.", moneyPrice: '500 руб.', alternativePrice: '10 печенек'},
                        ...
                        <div className={'advertisement-edit-body'}>
                            ...
                            <div className={'advertisement-edit-buttons'}>
                                ...
                                <MajorButton style={{width: 'max-content',
                                    padding: '4px 15px',
                                    borderRadius: '5px',
                                    margin: '0 0 0 10px' }}>Сохранить</MajorButton>
                            </div>
